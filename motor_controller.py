...
class AltitudeMotor():
    def __init__(self, rpimotor_function, alt, gpiopins, steps_360,  inv=False, wait=0.003, gear_ratio=1, steptype="full"):
        '''
...
class AzimuthMotor():
    def __init__(self, rpimotor_function, az, gpiopins, steps_360,  inv=False, wait=0.003, gear_ratio=1, steptype="full"):
        '''
        please provide gear ratio as a float corresponding to
        the amount of times to motor has to turn 360° to fully
        rotate to telescope once.
